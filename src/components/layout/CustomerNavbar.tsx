...
import { ShoppingCart, LogOut, Hexagon, Home, Store, Package, Star, UserCircle } from 'lucide-react';
        ...
        <header className="h-20 fixed top-0 w-full z-50 flex items-center justify-between px-6 2xl:px-12 bg-[#1A4731] shadow-md">
            ...
            <div onClick={() => router.push('/customer')} className="flex items-center space-x-3 cursor-pointer group flex-shrink-0">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-[10px] uppercase font-rajdhani text-[#D97706] tracking-widest font-bold" data-i18n="nav.customer_portal">{t('nav.customer_portal')}</span>
                </div>
            </div>
